...
export function loadConfig() {
  ...
  return {
    ...
    // Where Enter in the popup dashboard opens a box: a split below the pane the
    // popup floats over (default), a split beside it, or a new tab. Anything else
    // is below — a typo here must not strand the box in the overlay.
    dashboardPopupOpen: ["below", "right", "tab"].includes(dashboard.popup_open) ? dashboard.popup_open : "below",
